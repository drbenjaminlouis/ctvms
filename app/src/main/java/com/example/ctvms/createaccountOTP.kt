...
class createaccountOTP : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_createaccount_o_t_p, container, false)
        // Inflate the layout for this fragment
        val verifyBtn = view.findViewById<Button>(R.id.VerifyBtn)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Value1 = view.findViewById(R.id.otpVal1)
        Value2 = view.findViewById(R.id.otpVal2)
        Value3 = view.findViewById(R.id.otpVal3)
        Value4 = view.findViewById(R.id.otpVal4)
        Value5 = view.findViewById(R.id.otpVal5)
        Value6 = view.findViewById(R.id.otpVal6)
    ...
    data class OTPData(val Value1:String,val Value2:String,val Value3:String,val Value4:String,val Value5:String,val Value6:String)

    fun getOTPData(): OTPData? {
        ...
        return OTPData(Value1Text,Value2Text,Value3Text,Value4Text,Value5Text,Value6Text)
    }
